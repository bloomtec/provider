 ...
 */
	Configure::write('Security.salt', 'DYhG93b0qyJfIxfs2guVoUubWwasdfvniR2G0FgaC9mi');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '768593096544447453542496749683645');
 ...
 */
	...
	Inflector::rules('singular', array('irregular' => array('extensiones' => 'extension')));
	Inflector::rules('plural', array('irregular' => array('extension' => 'extensiones')));
