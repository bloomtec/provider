...
<?php echo $this -> Form -> create('Subcategoria'); ?>
	<fieldset>
		...
		<div class="actions">
			<ul>
				<li><?php echo $this -> Html -> link(__('Agregar Imagen Al Banner', true), array('controller' => 'imagenes', 'action' => 'add', 'Subcategoria', $this -> data['Subcategoria']['id']), array('style' => 'text-align:center; width: 200px;')); ?></li>
			</ul>
		</div>
	</fieldset>
