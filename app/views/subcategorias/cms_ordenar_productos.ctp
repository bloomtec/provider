<div class="productos index">
	<h2><?php echo "Productos en la Subcategoría: ".$subcategoria["Subcategoria"]["nombre"];?></h2>
	...
	<tr<?php echo $class;?> id="<?php echo $producto['id'];?>" > 
		<td><?php echo $producto['orden_en_subcategoria']; ?>&nbsp;</td>
...
<?php endforeach; ?>
	...
	var sendData=function(order){
		...
		$.post("/cms/productos/reOrderEnSubcategoria",
				data,
				function(response){
					if(response=="yes"){
						for(i=0;i<order.length;i+=1){
