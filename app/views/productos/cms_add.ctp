...
<?php echo $this->Form->create('Producto',array("id"=>"crearProducto"));?>
	...
	for($i=0;$i<1;$i++){
		...
		echo $this->Form->input('categoria_id',array("class"=>"selectCategoria","label"=>"Cátegoria","fila"=>$i,"modificar"=>true, 'id'=>'categoria'));
		echo $this->Form->input('subcategoria_id',array("class"=>"selectSubcategoria","label"=>"Subcátegoria","fila"=>$i,'id'=>'subcategoria'));
